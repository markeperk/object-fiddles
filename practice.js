...
favoriteThings.car = "Bronco II";
favoriteThings.brand = "Breitling";
...
user.name = "Mark Perkins";
user.pwHash = "u+adkfladkfj";
user.username = "markeperk";
